...
C {devices/vsource.sym} 310 -150 0 0 {name=VSUPP value="DC 3.3 AC 0"}
...
if MC_RUNS = 0
	...
	*foreach v_sweep 1.8
		...
		*alter @IBIAS0[pwl] = [ 0 0 100us 0 150us 10e-6 ]
  		tran 100n 200u
  		*plot vivdd#branch
		*plot v.x1.vmeassu1#branch
		*plot v.x1.vmeassu2#branch
		*plot v.x1.vmeasr#branch
		*plot v.x1.vmeasl#branch
		*plot v.x1.vmeasout#branch
		*plot VDD
		plot VREF
...
C {devices/isource.sym} 570 -290 0 0 {name=IBIAS0 value=6e-6}

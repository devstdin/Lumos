...
N 360 -610 410 -610 {
lab=#net3}
N 410 -750 570 -750 {lab=#net3}
N 360 -510 410 -510 {
lab=VINP}
N 410 -570 580 -570 {lab=VINP}
N 550 -540 580 -540 {lab=VSS}
N 550 -660 580 -660 {lab=VDD}
...
C {devices/lab_pin.sym} 550 -660 0 0 {name=p7 lab=VDD}
C {devices/lab_pin.sym} 550 -540 0 0 {name=p8 lab=VSS}
...
device=resistor
m=1}
C {devices/vsource.sym} 310 -250 0 0 {name=VSUPP value="DC 1.65 AC 0"}
...
C {devices/vsource.sym} 310 -150 0 0 {name=VSUPN value="DC 1.65 AC 0"}
